...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    //$exists=false
    $existSql = "SELECT * FROM `users` WHERE username = '$username' order by username desc ";
...
<html lang="en">
  ...
  <body background="loogin2.jpeg">
    ...
    <center><H1 style="color:white">ℂ𝕠𝕞𝕡𝕦𝕥𝕖𝕣 𝕤𝕖𝕣𝕧𝕚𝕔𝕖 𝕞𝕒𝕟𝕒𝕘𝕖𝕞𝕖𝕟𝕥 𝕤𝕪𝕤𝕥𝕖𝕞</H1></center><br><br><br><br>
     ...
     <form action="/loginsystem/signup.php" method="post">
        ...
        <div class="form-group">
            <label for="cpassword"style="color:white"><b>Confirm Password</b></label>
